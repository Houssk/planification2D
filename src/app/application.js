...
dwv.App = function ()
{
     ...
     */
    this.getVersion = function () { return "v0.15.0-beta"; };
    ...
    function postLoadInit(data)
    {
        ...
        /**
         *  R�cup�ration de la taille de la bille en mm via un pop-up
        ...
        buttonCalibrage.addEventListener('click', function() {
                swal({
                    title: translatedTexts["scaleText"][lang],
                    text: translatedTexts["enterBallSizeText"][lang],
                    type: "input",
                    showCancelButton: true,
                    closeOnConfirm: true,
                    animation: "slide-from-top",
                    inputPlaceholder: translatedTexts["sizeText"][lang]
                },
                function(inputValue){
                    if (inputValue === false)
                        return false;
                    if (inputValue === "") {
                        swal.showInputError(translatedTexts["fillAllText"][lang]);
                        return false;
                    }
