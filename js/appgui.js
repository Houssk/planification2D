...
dwv.gui.Toolbox = function (app)
{
    ...
    this.setup = function(list)
    {
        ...
        var actionsCotyle = document.createElement("button");
        actionsCotyle.appendChild(document.createTextNode("Actions Cotyle"));
        actionsCotyle.onclick = function() { toggle("#actionsCotyle"); };
        ...
        node.appendChild(actionsCotyle);
...
dwv.gui.setup = function () {
    ...
    $("#history").dialog({ position: 
        {my: "left top+520", at: "left top", of: "#pageMain"} });
    $("#actionsImplant").dialog({ position: 
        {my: "right top+10", at: "right top", of: "#pageMain"} });
    $("#actionsCotyle").dialog({ position: 
        {my: "right top+185", at: "right top", of: "#pageMain"} });
    $("#couleurArrierePlan").dialog({ position: 
        {my: "right top+400", at: "right top", of: "#pageMain"} });
